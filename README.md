...
All data are stored in NumPy .npz format and are organized figure-wise. For each figure, the corresponding datasets are saved separately (in some cases split into multiple parts for clarity)
